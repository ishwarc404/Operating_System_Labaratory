...
main(int argc, char *argv[])
{
 ...
 120:	d9 05 84 08 00 00    	flds   0x884
...
free(void *ap)
{
 ...
 6f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6f9:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
 ...
 71a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 71d:	a3 30 0b 00 00       	mov    %eax,0xb30
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 78f:	76 3f                	jbe    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	39 05 30 0b 00 00    	cmp    %eax,0xb30
 ...
 7b6:	e8 e5 fe ff ff       	call   6a0 <free>
  return freep;
 7bb:	8b 15 30 0b 00 00    	mov    0xb30,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7df:	89 15 30 0b 00 00    	mov    %edx,0xb30
      return (void*)(p + 1);
 ...
 7f4:	eb e9                	jmp    7df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7f6:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 7fd:	0b 00 00 
 800:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 34 0b 00 00       	mov    $0xb34,%eax
 80f:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 816:	00 00 00 
